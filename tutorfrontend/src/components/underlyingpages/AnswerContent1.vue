<template>
    <div>
        <form class="custom-ans" @submit.prevent="patchAnswer">
            ...
            <div id="answer1-patch" ref ="editorContainer"></div>
...
export default {
    ...
    methods:{
        ...
        handleFileUpload(event) {
            ...
            reader.onload = (e) => {
                this.quillpatch.root.innerHTML = e.target.result;
            };
            reader.readAsText(file);
        },
    },
    mounted(){
        this.quillpatch = new Quill('#answer1-patch', {
        theme: 'snow',
